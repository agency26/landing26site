...
import { Zap, Target, Search, Sparkles, CheckCircle2, ArrowRight, MessageCircle, Star, MapPin, Briefcase } from "lucide-react";
...
const Index = () => {
  ...
  return <div className="min-h-screen">
      <SEOHead title="Landing page IA livrée en 3 jours – 499 € HT | Landing26" description="Landing page premium en 3 jours pour 499 € HT. Design fintech + SEO + IA. Conversion maximale, livraison express." canonical="https://landing26.fr" />
      <Header />
      ...
      <section className="relative overflow-hidden border-b border-border">
        ...
        <div className="absolute bottom-0 -right-40 w-96 h-96 bg-primary-purple/20 rounded-full blur-3xl animate-float" style={{
        animationDelay: "1s"
      }}></div>
        ...
        <div className="container relative mx-auto px-4 py-24 md:py-36">
          <div className="mx-auto max-w-4xl text-center">
            <div className="mb-6 inline-flex items-center gap-2 rounded-full border-2 border-secondary/30 bg-secondary/10 px-5 py-2.5 text-sm font-semibold text-secondary backdrop-blur-sm animate-fade-in-down shadow-lg">
              ...
              <span>+30 landing pages livrées</span>
            </div>
            
            <h1 className="mb-6 animate-fade-in-up font-black tracking-tight leading-tight md:leading-relaxed">
              Votre landing page pro <span className="whitespace-nowrap">en 3 jours</span> — <span className="bg-gradient-to-r from-orange-accent via-primary to-primary-dark bg-clip-text text-transparent whitespace-nowrap">499 € HT</span>
            </h1>
            ...
            <div className="flex flex-col items-center justify-center gap-4 sm:flex-row animate-fade-in-up" style={{
            animationDelay: "0.4s"
          }}>
              <GradientButton size="lg" className="text-lg shadow-2xl" onClick={() => document.getElementById("contact-form")?.scrollIntoView({
              behavior: "smooth"
            })}>
              ...
              <Button size="lg" variant="outline" asChild className="border-2 border-secondary/50 text-lg hover:bg-secondary/10 hover:border-secondary hover:scale-[1.02] transition-all font-semibold">
                <a href="https://wa.me/33768410643?text=Bonjour" target="_blank" rel="noopener noreferrer">
            ...
            <div className="mt-10 flex flex-wrap items-center justify-center gap-8 text-sm font-medium text-muted-foreground animate-fade-in-up" style={{
            animationDelay: "0.6s"
          }}>
      ...
      <section className="border-b border-border bg-white py-24 relative overflow-hidden">
        ...
        <div className="container relative mx-auto px-4">
          <div className="mx-auto mb-16 max-w-2xl text-center">
            ...
            <p className="text-xl text-muted-foreground font-medium animate-fade-in" style={{
            animationDelay: "0.1s"
          }}>
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            {features.map((feature, index) => <Card key={index} className="group border-2 border-border bg-white transition-all duration-300 hover:border-secondary hover:shadow-2xl hover:shadow-secondary/20 hover:-translate-y-2 animate-fade-in-up" style={{
      ...
      <section className="border-b border-border bg-gradient-to-br from-muted via-background to-secondary/5 py-24 relative overflow-hidden">
        ...
        <div className="absolute bottom-10 right-10 w-64 h-64 bg-primary-purple/5 rounded-full blur-3xl animate-pulse" style={{
        animationDelay: "1s"
      }}></div>
              ...
              <CardContent className="p-8 md:p-14">
                <div className="mb-10 flex flex-col items-center justify-between gap-6 border-b-2 border-border pb-10 md:flex-row">
                  ...
                  <div className="text-center">
                    <div className="mb-2 bg-gradient-to-r from-orange-accent via-primary to-primary-dark bg-clip-text text-4xl md:text-5xl font-black text-transparent">499 €</div>
                    <div className="text-sm text-muted-foreground font-semibold">HT</div>
                  </div>
                </div>

                <div className="grid gap-5 md:grid-cols-2">
                  {["Design sur mesure premium", "SEO de base inclus", "Responsive mobile-first", "Copywriting optimisé IA", "Hébergement inclus", "Formulaire de contact", "Analyse de performance", "Support 7j après livraison"].map((item, index) => <div key={index} className="flex items-start gap-3 group animate-fade-in-up" style={{
                ...
                <div className="mt-10 text-center">
                  <GradientButton size="lg" asChild className="shadow-2xl w-full sm:w-auto">
                    <a href="https://calendly.com/kabalodov/rdv" target="_blank" rel="noopener noreferrer" className="whitespace-normal sm:whitespace-nowrap">
      ...
      <section className="border-b border-border bg-white py-24">
        <div className="container mx-auto px-4">
          ...
          <div className="mx-auto grid max-w-5xl gap-6 md:grid-cols-4">
            {processSteps.map((step, index) => <div key={index} className="relative animate-fade-in-up" style={{
            animationDelay: `${index * 0.15}s`
                ...
                {index < processSteps.length - 1 && <div className="absolute right-0 top-1/2 hidden h-1 w-6 -translate-y-1/2 translate-x-full bg-gradient-to-r from-secondary to-primary-purple md:block opacity-40" />}
              </div>)}
          </div>
      ...
      <section className="border-b border-border bg-gradient-to-br from-background via-secondary/5 to-background py-24 relative overflow-hidden">
        ...
        <div className="container relative mx-auto px-4">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            {testimonials.map((testimonial, index) => <Card key={index} className="border-2 border-border bg-card transition-all duration-300 hover:border-secondary/50 hover:shadow-2xl hover:-translate-y-2 hover:shadow-secondary/20 animate-fade-in-up group" style={{
            animationDelay: `${index * 0.1}s`
          }}>
                <CardContent className="pt-8">
                  <div className="mb-6 flex gap-1">
                    {[...Array(5)].map((_, i) => <Star key={i} className="h-6 w-6 fill-yellow-400 text-yellow-400 group-hover:scale-110 transition-transform" style={{
          ...
          <div className="mx-auto max-w-6xl">
            ...
            <Tabs defaultValue="villes" className="w-full">
              <TabsList className="grid w-full max-w-md mx-auto grid-cols-2 mb-12 h-14 bg-muted/50 p-1 rounded-2xl">
                <TabsTrigger value="villes" className="rounded-xl data-[state=active]:bg-gradient-to-r data-[state=active]:from-primary data-[state=active]:via-primary-orange data-[state=active]:to-primary-purple data-[state=active]:text-white font-bold text-base transition-all">
                  <MapPin className="mr-2 h-5 w-5" />
                  Villes
                </TabsTrigger>
                <TabsTrigger value="secteurs" className="rounded-xl data-[state=active]:bg-gradient-to-r data-[state=active]:from-primary data-[state=active]:via-primary-orange data-[state=active]:to-primary-purple data-[state=active]:text-white font-bold text-base transition-all">
              ...
              <TabsContent value="villes" className="mt-0">
                ...
                <div className="flex flex-wrap justify-center gap-4">
                  {villes.slice(0, 12).map((ville, index) => <Link key={ville.slug} to={`/ville/${ville.slug}`} className={`group inline-flex items-center rounded-xl border-2 border-border bg-card px-6 py-3 text-sm font-semibold transition-all hover:border-secondary hover:bg-secondary/10 hover:shadow-lg hover:shadow-secondary/20 hover:-translate-y-1 animate-fade-in-up ${index >= 6 ? 'hidden md:inline-flex' : ''}`} style={{
                  animationDelay: `${index * 0.05}s`
                }}>
              ...
              <TabsContent value="secteurs" className="mt-0">
                ...
                <div className="flex flex-wrap justify-center gap-4">
                  {secteurs.filter(secteur => secteur.secteur !== 'Comptable' && secteur.secteur !== 'Expert SEO').slice(0, 12).map((secteur, index) => <Link key={secteur.slug} to={`/secteur/${secteur.slug}`} className={`group inline-flex items-center rounded-xl border-2 border-border bg-card px-6 py-3 text-sm font-semibold transition-all hover:border-secondary hover:bg-secondary/10 hover:shadow-lg hover:shadow-secondary/20 hover:-translate-y-1 animate-fade-in-up ${index >= 6 ? 'hidden md:inline-flex' : ''}`} style={{
                  animationDelay: `${index * 0.05}s`
                }}>
                        <span className="text-foreground group-hover:text-secondary transition-colors">
                          {secteur.secteur}
