...
const Index = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="border-b border-border bg-gradient-to-br from-white via-secondary/10 to-white py-24 relative overflow-hidden">
        {/* Background decoration */}
        <div className="absolute top-0 right-1/4 w-80 h-80 bg-primary-purple/5 rounded-full blur-3xl"></div>
        
        <div className="container relative mx-auto px-4">
          <div className="mx-auto mb-16 max-w-2xl text-center">
            <h2 className="mb-4 font-black animate-fade-in">Nos dernières créations</h2>
            <p className="text-xl text-muted-foreground font-medium animate-fade-in" style={{ animationDelay: "0.1s" }}>
              Découvrez quelques exemples de landing pages premium créées par Landing26.
            </p>
          </div>

          <div className="grid gap-10 md:grid-cols-2 max-w-6xl mx-auto">
            {/* Adoucisseur de France */}
            <Card className="group border-2 border-border bg-card transition-all duration-500 hover:border-secondary/50 hover:shadow-2xl hover:-translate-y-2 hover:shadow-secondary/20 overflow-hidden animate-fade-in-up">
              <CardContent className="p-0">
                <div className="relative overflow-hidden bg-gradient-to-br from-dark via-dark-secondary to-dark aspect-video">
                  <img 
                    src="/src/assets/realisations/adoucisseur-france.png" 
                    alt="Adoucisseur de France - Landing page" 
                    className="w-full h-full object-cover object-top transition-transform duration-500 group-hover:scale-105"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-dark/80 via-dark/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                </div>
                <div className="p-8">
                  <h3 className="text-2xl font-bold mb-3 group-hover:text-secondary transition-colors">Adoucisseur de France</h3>
                  <p className="text-muted-foreground mb-4 leading-relaxed">
                    Landing page premium pour adoucisseurs d'eau avec design fintech, animations modernes et conversion optimisée.
                  </p>
                  <div className="flex flex-wrap gap-2 mb-6">
                    <span className="inline-flex items-center gap-1 px-3 py-1 bg-secondary/10 text-secondary rounded-full text-sm font-semibold">
                      <Sparkles className="h-3 w-3" />
                      Design premium
                    </span>
                    <span className="inline-flex items-center gap-1 px-3 py-1 bg-primary-purple/10 text-primary-purple rounded-full text-sm font-semibold">
                  ...
                  <Button 
                    variant="outline" 
                    asChild
                    className="w-full border-2 hover:border-secondary hover:bg-secondary/10 hover:scale-105 transition-all font-semibold group"
                  >
                    <a href="https://adoucisseurdefrance.fr/" target="_blank" rel="noopener noreferrer">
                      Voir le site
            ...
            {/* Leadmaps26 */}
            <Card className="group border-2 border-border bg-card transition-all duration-500 hover:border-secondary/50 hover:shadow-2xl hover:-translate-y-2 hover:shadow-secondary/20 overflow-hidden animate-fade-in-up" style={{ animationDelay: "0.15s" }}>
              <CardContent className="p-0">
                <div className="relative overflow-hidden bg-gradient-to-br from-dark via-dark-secondary to-dark aspect-video">
                  <img 
                    src="/src/assets/realisations/leadmaps26.png" 
                    alt="Leadmaps26 - Landing page" 
                    className="w-full h-full object-cover object-top transition-transform duration-500 group-hover:scale-105"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-dark/80 via-dark/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                </div>
                <div className="p-8">
                  <h3 className="text-2xl font-bold mb-3 group-hover:text-secondary transition-colors">Leadmaps26</h3>
                  <p className="text-muted-foreground mb-4 leading-relaxed">
                    Plateforme B2B pour estimation de leads avec interface épurée, simulateur intégré et design moderne.
                  </p>
                  <div className="flex flex-wrap gap-2 mb-6">
                    <span className="inline-flex items-center gap-1 px-3 py-1 bg-secondary/10 text-secondary rounded-full text-sm font-semibold">
                  ...
                  <Button 
                    ...
                    className="w-full border-2 hover:border-secondary hover:bg-secondary/10 hover:scale-105 transition-all font-semibold group"
                  >
                    <a href="https://leadmaps26.fr/" target="_blank" rel="noopener noreferrer">
                      Voir le site
                      <ArrowRight className="ml-2 h-4 w-4 group-hover:translate-x-1 transition-transform" />
                    </a>
                  </Button>
          ...
          <div className="mt-16 text-center animate-fade-in-up" style={{ animationDelay: "0.3s" }}>
            <p className="text-lg text-muted-foreground mb-6 font-medium">
              Votre projet mérite le même niveau de qualité.
            </p>
            <GradientButton
              size="lg"
              asChild
